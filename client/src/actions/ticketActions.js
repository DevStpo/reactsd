...
import { GET_TICKETS, GET_TICKET, ADD_TICKET, ADD_STANDARD_FIELDS, UPDATE_TICKET_STATUS, DELETE_TICKET, TICKETS_LOADING } from './types';
...
export const updateTicketStatus = (id, workflowStep, nextStatus) => dispatch => {
  dispatch(setTicketsLoading());
