...
router.put('/:id', (req, res) => {
  Ticket.findByIdAndUpdate(req.params.id, { $set: { workflowStep: req.body.workflowStep, status: req.body.nextStatus }}, { new: true })
    .populate('comments')
    .populate('ticketType')
    .populate('workflow')
    .exec()
...
router.put('/comments/:id', (req, res) => {
  Ticket.findByIdAndUpdate(req.params.id, { $push: { comments: req.body._id}}, { new: true })
